...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
        ...
        CALL GET_GAUSS_COEFF(COEFF, G_COEFF)
...
C       (5,-2)
        G_COEFF(10,3)=5393233.0D0/5393233.0D0
...
C       (5,1)
        G_COEFF(9,6)= 135352319.0D0/3628800.0D0
...
C       (4,-1)
        G_COEFF(9,4)= 531521.0D0/39916800.0D0
...
C       (5,1)
        G_COEFF(9,6)= -159314453.0D0/19958400.0D0
