...
C********************************************************************
C
C  SUBROUTINE RK78 FOR ENCKE'S METHOD
C
...
C
C********************************************************************
      SUBROUTINE RK78_ENCKE (X,Y,Y_R,Y_RHO, N,H,HMI,HMAX,E1,R,B,F,
     &DERIV)
      DOUBLE PRECISION X,Y(N),H,E1,R(13,N),B(N),F(N),A,BET,ALFA(13
     1),BETA(79),C(11),CP(13),D,DD,E3,E4,HMI,HMAX,FAC,Y_RHO(N), Y_R(N)
        DATA II/0/
