...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
        ...
        SUBROUTINE RK89_ENCKE(V_T, VDIM, ENCKE_RHO, VSTATE, VDT,
     & V_EXTERNAL, OSTATE)
        IMPLICIT NONE
...
10      COUNTER=COUNTER+1
        ...
        CALL V_EXTERNAL(V_T, ENCKE_RHO, VSTATE, VDIM, TEMP_X)
...
C
C           Calc and pass delta_r.
C


            CALL V_EXTERNAL(TEMP_T,ENCKE_RHO, TEMP_X, VDIM, TEMP_FK)
